...
# bash GAPartMobile/scripts/train_mm.sh set_table place 024_bowl 4 128

# bash GAPartMobile/scripts/train_mm.sh set_table place 024_bowl 3 512
...
# 直接运行训练命令，不进行恢复检查
CUDA_VISIBLE_DEVICES=$GPU_ID python -m GAPartMobile.main \
