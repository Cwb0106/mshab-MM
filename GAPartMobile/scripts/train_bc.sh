...
# bash GAPartMobile/scripts/train_bc.sh set_table place 024_bowl 4 1024

# bash GAPartMobile/scripts/train_bc.sh set_table place 024_bowl 3 512
...
# shellcheck disable=SC2001
PROJECT_NAME="MS-HAB-RCAD-bccnn"
...
# 直接运行训练命令，不进行恢复检查
CUDA_VISIBLE_DEVICES=$GPU_ID python -m GAPartMobile.main_backup \
